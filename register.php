...
<html>
<head>
    <title>Welcome to SlingoMusix!</title>
        ...
        <div id="inputContainer">
            <form id="loginForm" action="register.php" method="POST">
                ...
                <div class="hasAccountText">
                    <span id="hideLogin">Signup here</span>
                </div>
            ...
            <form id="registerForm" action="register.php" method="POST">
                ...
                <p>
                    ...
                    <input id="email2" name="email2" type="email" placeholder="johndoe@gmail.com"
                ...
                <div class="hasAccountText">
                    <span id="hideRegister">Log in here</span>
                </div>
